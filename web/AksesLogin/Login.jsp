<%-- 
    Document   : Login
    Created on : Feb 6, 2022, 1:58:32 PM
    Author     : HP
--%>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">SELAMAT DATANG DI SIKEL PCR!</h1>
                                    </div>
                                    <form class="user" method="post" action="OlahLogin.jsp">
