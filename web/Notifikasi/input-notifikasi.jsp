                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Menu Notifikasi | Tambah Notifikasi</h1>
                        </div>

                        <div class="container">
                            <form action="../inputnotifikasi" method="post">
                                <input type="hidden" name="id_pembelian" value="<%= belanja.get(1).get(0)%>">
                                <div class="form-group">
                                    <label for="no_pengajuan">Nomor Pengajuan</label>
                                    <input type="text" class="form-control" name="no_pengajuan" value="<%= belanja.get(1).get(0)%> - Pengajuan Belanja <%= belanja.get(1).get(4)%>" id="no_pengajuan" aria-describedby="emailHelp" placeholder="Ex: Mouse Logitechy">
                                </div>

                                <div class="form-group">
                                    <label for="status">Status Pengajuan</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" id="status" value="terima">
                                        <label class="form-check-label" for="status">
                                            Diterima
                                        </label>
                                        <input class="form-check-input" type="radio" name="status" id="status2" value="tolak">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="deskripsi" class="form-control" id="desc" rows="3"></textarea>
                                </div>
