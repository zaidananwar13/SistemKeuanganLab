            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="tambah-daftar-belanja.jsp" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                          <i class="fas fa-plus fa-sm text-white-50"></i> Tambah Daftar Belanja
                        </a>
                    </div>
                    ...
                    <div class="container">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          <% for(int i = 1; i < belanjaan.size(); i++) { %>
                          <tr>
                            <th scope="row"><%= i %></th>
                            <td scope="col"><%= belanjaan.get(i).get(4) %></td>
                            <td scope="col"><%= belanjaan.get(i).get(5) %></td>
                            <td scope="col"><%= belanjaan.get(i).get(6) %></td>
                            <% supplier =  Database.getData("select nama_supplier from supplier where id_supplier='" + belanjaan.get(i).get(1) + "'", Database.connection); %>
                            <td scope="col"><%= supplier.get(1).get(0) %></td>
                            <td scope="col"><%= belanjaan.get(i).get(7) %></td>
                            <td>
                              <div class="dropdown">
                                <i class="fas fa-filter" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                </i>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  <a class="dropdown-item" href="../Notifikasi/input-notifikasi.jsp?id=<%= belanjaan.get(i).get(0) %>">Pengajuan Dana</a>
                                  <a class="dropdown-item" href="edit-belanja.jsp?id=<%= belanjaan.get(i).get(0) %>">Edit</a>
                                  <a onclick="return confirm('Apakah anda yakin untuk menghapus data?')" class="dropdown-item" href="hapus-belanja?id=<%= belanjaan.get(i).get(0) %>">Hapus</a>
                                </div>
                              </div>
                            </td>
                          </tr>
