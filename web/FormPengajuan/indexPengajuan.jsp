...
<html lang="en">
    ...
    <head>
        ...
        <title>Sistem Keuangan Lab</title>
...
<body id="page-top">
        <div id="wrapper">
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../FormPengajuan/notif_pengajuan.jsp">
                        ...
                        <div class="container-fluid">
                            ...
                            <form class="user" method="post" action="simpan_pengajuan.jsp">
                                <div class="position-relative form-group">
                                    ...
                                    <input name="id_ail" id="exampleEmail" placeholder="" 
                                           type="text" class="form-control">
                                </div>
                                <div class="position-relative form-group">
                                    <label for="exampleEmail" class="">Nama Barang</label>
                                    <input name="nama_barang" id="exampleEmail" placeholder="" 
                                           type="text" class="form-control">
                                </div>
                                <div class="position-relative form-group">
                                    <label for="exampleEmail" class="">Jumlah Barang</label>
                                    <input name="jumlah_barang" id="exampleEmail" placeholder="" 
                                           type="number" class="form-control">
                                </div>
                                <div class="position-relative form-group">
                                    <label for="exampleEmail" class="">Tanggal</label>
                                    <input name="tanggal_pengajuan" id="exampleEmail" placeholder="" 
